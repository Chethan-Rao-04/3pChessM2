...
class BishopTest {
    ...
    void setupDirections_bishopCanMoveInDiagonalDirections_True() {
        ...
        Set<Position> moves = bishop.getHighlightPolygons(boardMap, startPos);
    ...
    void isLegalMove_bishopMovesToEmptySquare_True(Colour colour) {
        ...
        Set<Position> actualBishopMoves = bishop.getHighlightPolygons(boardMap, bishopPosition);
        // Test diagonal move
    ...
    void isLegalMove_bishopTakesItsColourPiece_False(ChessPiece piece) {
        ...
        Set<Position> actualBishopMoves = bishop.getHighlightPolygons(boardMap, BE2);
     ...
     */
    @Test
    void getHighlightPolygons_bishopMovesAcrossBoardSections_True() {
        boardMap.clear();
        Position startPosition = BE4; // Edge of blue section
        ChessPiece bishop = new Bishop(Colour.BLUE);
        boardMap.put(startPosition, bishop);
        Set<Position> moves = bishop.getHighlightPolygons(boardMap, startPosition);
